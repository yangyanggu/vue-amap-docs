import{p as v,j as f,f as x,_ as P,o as h,c as j,d as y}from"./app-B1hdasWK.js";const S=v({__name:"vp-codepen",props:{css:{type:String,required:!0},cssPreProcessor:{type:String,required:!0},js:{type:String,required:!0},jsPreProcessor:{type:String,required:!0},html:{type:String,required:!0}},setup(p,{expose:c}){const e=p,s={"'vue'":"Vue","'element-plus'":"ElementPlus"},n=f(()=>{const t=decodeURIComponent(e.js||""),r=/(import*) ([^'\n]*) from ([^\n]*)/g,m=[];let l;for(;l=r.exec(t);){const[,,_,g]=l;m.push(`const ${_} = ${s[g]};`)}let o=(t.includes("export default defineComponent")?/export default defineComponent\({([\s\S]*)}\)/g:/export default {([\s\S]*)}/g).exec(t);return o=(o&&o[1]||"").replace(/\n {2}/g,`
`).trim(),`${m.join(`
`)}
var Main = {
  ${o}
